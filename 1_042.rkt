...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 1_042) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
; according to the given world state 
 (define (render cw)
   (place-image/align CAR cw Y-CAR "right" "middle" BACKGROUND))
